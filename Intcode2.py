class Intcode :
    ...
    def __doAction__(self) :
        if self.code == 1:
            ...
            if len(self.inputs) == 0 :
                self.puzzleinput[self.__getPositionValue__(1)] = -1
            else :
                self.puzzleinput[self.__getPositionValue__(1)] = self.inputs.pop(0)
        elif self.code == 5:
    ...
    def addInputs(self, inputArray) :
        self.inputs = self.inputs + inputArray
